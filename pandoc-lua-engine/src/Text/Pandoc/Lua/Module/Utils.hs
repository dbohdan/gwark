...
-- gwark fork: citeproc removed; pandoc.utils.citeproc and
-- pandoc.utils.references are no longer exposed.
...
-- gwark fork: pandoc.utils.citeproc removed (citeproc dropped).
...
-- gwark fork: pandoc.utils.references removed (citeproc dropped).
